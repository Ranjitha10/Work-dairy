...
$quer2="SELECT DISTINCT dept FROM reg order by dept"; 
///////////// End of query for first list box////////////

/////// for second drop down list we will check if category is selected else we will display all the subcategory///// 
if(isset($cat) and strlen($cat) > 0){
$quer="SELECT DISTINCT name,profid FROM reg where dept='$cat' order by name"; 
}else{$quer="SELECT DISTINCT name,profid FROM reg order by name"; } 
...
if($noticia2['dept']==@$cat){echo "<option selected value='$noticia2[dept]'>$noticia2[dept]</option>"."<BR>";}
else{echo  "<option value='$noticia2[dept]'>$noticia2[dept]</option>";}
}
echo "</select>";
...
echo  "<option value='$noticia[profid]'>$noticia[name]</option>";
}
echo "</select>";
